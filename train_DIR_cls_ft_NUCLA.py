...
def main(args):
    ...
    for epoch in range(1, args.Epoch+1):
        ...
        for i, sample in enumerate(trainloader):
            ...
            actPred, lastFeat, binaryCode, output_skeletons = net(input_skeletons, bi_thresh=args.gumbel_thresh)
        ...
        if epoch % 20 == 0:
            ...
            Acc = testing(testloader, net, args.gpu_id, args.sampling, args.mode, args.withMask, args.gumbel_thresh)
